  ...
  return (
    <div
      className={`h-screen bg-[#202124] flex flex-col ${
        collapsed ? "w-16" : "w-80"
      } text-gray-300 overflow-hidden transition-all duration-300 relative border-r border-gray-800`}
      style={{ boxShadow: "0 0 15px rgba(0,0,0,0.3)" }}
    >
      <div className="flex items-center justify-between p-3 mx-2 my-2 mb-3">
        {!collapsed && (
        ...
        <button
          ...
          className="p-2 rounded-full hover:bg-[#303134] transition-colors"
        >
          {collapsed ? (
      ...
      {!collapsed && (
        <>
          <div className="px-4 mb-2">
            <div className="relative">
              <input
                ...
                className="w-full bg-[#303134] text-[#CACACA] rounded-lg px-9 py-2 text-sm border border-transparent focus:border-[#8A92E3]/30 focus:outline-none transition-colors"
              />
              <Search
                size={16}
          ...
          <div className="px-4 mb-2 flex space-x-1">
            <button
              onClick={() => setActiveFilter("all")}
              className={`px-3 py-1.5 text-xs rounded-lg transition-colors ${
                activeFilter === "all"
                  ? "bg-[#8A92E3]/10 text-[#8A92E3]"
                  : "bg-[#303134] text-[#CACACA] hover:bg-[#3a3b3f]"
              }`}
            >
              All
            </button>
                  ...
                  .map((chat) => (
                    <div key={chat.conversation_id}>
                      <Link
                        ...
                        className={`group flex items-center justify-between my-1.5 px-3 py-2 hover:bg-[#2c2d31] cursor-pointer rounded-lg ${
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                          <button
                            ...
                            className={`p-1.5 rounded-lg hover:bg-[#3a3b3f] transition-all duration-150 ${
      ...
      <div className="mt-auto border-t border-gray-800 pt-2">
          ...
          {collapsed ? (
            <>
              <div className="flex flex-col items-center gap-2 mt-2">
                <div className="flex items-center justify-center w-10 h-10 hover:bg-[#303134] cursor-pointer rounded-lg relative">
                  <HelpCircle size={18} className="text-[#CACACA]" />
                  <div className="h-2 w-2 bg-red-500 rounded-full absolute top-1 right-1"></div>
                </div>
                <div className="flex items-center justify-center w-10 h-10 hover:bg-[#303134] cursor-pointer rounded-lg">
            ...
            <>
              <div className="flex items-center px-4 py-2 hover:bg-[#303134] cursor-pointer rounded-lg mx-2 relative">
              ...
              <div className="flex items-center px-4 py-2 hover:bg-[#303134] cursor-pointer rounded-lg mx-2">
        ...
        {!collapsed && (
          <div className="px-5 py-3 text-xs text-[#CACACA]/80 bg-[#252629] rounded-lg mx-2 mb-2">
